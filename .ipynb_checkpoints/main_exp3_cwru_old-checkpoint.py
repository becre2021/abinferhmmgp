...
def split_segment_dict(segments_dict):
    ...
    for ith_key in segments_dict:
        ...
        numtrain = int(len(segments_dict[ith_key])*0.66)    
...
data_filepath = './dataset/CWRU/Data/12k_DE/*.mat'
...
#fs = 12*k
numstate = 4
z_train = sample_hidden_state(numstate,trans_matrix,numsample=200)
z_test = sample_hidden_state(numstate,trans_matrix,numsample=100)
